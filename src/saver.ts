...
<section class="stats-card"><div class="stats-card-head"><h2>職 Top1000 推移</h2><div class="stats-card-actions"><p class="stats-note">日付ごとに1本の帯で、Top1000の職構成を表示します。凡例を押すと職ごとに表示を切り替えられます。</p><button class="btn excel" id="stats-png" type="button">帯グラフをPNG保存</button><a class="btn" href="https://github.com/Lily-0619/bdm-node-war-tracker/edit/main/public/class-colors.md" target="_blank" rel="noopener">色設定MDを編集</a></div></div><div id="class-chart"></div><div id="latest-class-top5" class="latest-class-top5"></div></section>
